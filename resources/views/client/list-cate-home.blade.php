                                                ...
                                                <div class="toolbar-inner">
                                                    <div class="product-view-mode">
                                                        <ul role="tablist" class="nav shop-item-filter-list">
                                                            <li role="presentation"><a href="#grid" aria-controls="grid" role="tab" data-toggle="tab"><i class="ion-md-grid"></i></a></li>
                                                        </ul>
                                                    </div>
                                                    <div class="toolbar-amount">
                                                        <strong>Tổng Sản Phẩm Danh Mục <span class="badge badge-success">{{$cate_name->cate_name}} </span> </strong>
                                                                    ...
                                                                    <div class="product-inner">
                                                                        <div class="product-image">
                                                                            ...
                                                                            <a href="{{route('detail.product', ['id' => $pro->id])}}">
                                                                                <img src="{{URL::to('/')}}/{{$pro->image}}" alt="Compete Track Tote" title="Compete Track Tote">
                                                                            </a>
